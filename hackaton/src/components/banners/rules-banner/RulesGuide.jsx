    ...
    <>
      <div className="px-10 grid gap-5 place-items-center grid-cols-1 lg:grid-cols-2 bg-mainBlue banner-left">
        <div className="left w-full relative order-2 lg:order-1">
          <img className="w-4 h-4 absolute right-10 lg:right-1/2" src={greyStar} alt="" />
          <h2 className="text-white text-xl text-center lg:text-left lg:text-3xl pt-4 pb-1 font-custom font-bold">Rules and</h2>
          <h2 className="text-brightPurple text-xl text-center lg:text-left lg:text-3xl py-1 font-custom font-bold">Guidelines</h2>
          ...
          <img className="w-3 h-3 absolute right-4" src={star} alt="" />
        </div>
